      ...
      <main>
        ...
        <section className="relative h-[600px] flex items-center bg-[#f8f9fa] overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="max-w-2xl animate-fade-in-up">
              <span className="text-[#4A90D9] font-bold tracking-widest uppercase text-sm mb-4 block">Rippa DOM TOM</span>
        ...
        <section id="minipelles" className="py-24 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl font-serif font-bold text-[#4A90D9]">Mini-pelles Série Pro</h2>
        ...
        <section className="py-20 bg-gray-50 border-t border-gray-100">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-serif font-bold text-[#4A90D9] mb-6">Besoin d'accessoires ?</h2>
