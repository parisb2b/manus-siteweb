...
export default function ModularHomes() {
  const { products, loading } = useProducts("Maisons");
  const { page } = usePageContent("maisons");
      ...
      <main>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl font-serif font-bold text-[#4A90D9]">{page?.pageTitle || "Maisons & Studios"}</h2>
        ...
        <section className="py-20 bg-gray-50 border-t border-gray-100">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-serif font-bold text-[#4A90D9] mb-6">{page?.ctaTitle || "Un projet sur mesure ?"}</h2>
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              {page?.ctaDescription || "Nos équipes vous accompagnent dans la conception de votre espace modulaire idéal. Contactez-nous pour une étude personnalisée."}
            </p>
